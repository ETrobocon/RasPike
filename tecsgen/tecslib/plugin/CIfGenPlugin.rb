...
#== MultiPlugin クラス
class CIfGenPlugin < MultiPlugin
  def self.get_plugin superClass
    ...
    if superClass == SignaturePlugin then
      ...
      require_tecsgen_lib "tecslib/plugin/CIfGenCelltypePlugin.rb"
      return CIfGenCelltypePlugin
    elsif superClass == CellPlugin then
      require_tecsgen_lib "tecslib/plugin/CIfGenCellPlugin.rb"
      return CIfGenCellPlugin
